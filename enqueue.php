...
function theme_enqueue_assets() {
    ...
    if (is_singular('case')) {
        wp_enqueue_style('portfolio-style', get_template_directory_uri() . '/assets/css/portfolio.css', [], '1.0');
        wp_enqueue_script('portfolio-script', get_template_directory_uri() . '/assets/js/portfolio.js', [], '1.0', true);
    }
}
